...
# Fix error: Declaration of getGalleryTab::getTabTitle
...
# Fix wrong version number because it is not compatible with current cb version
+ Add cb release number
...
# Fix deprecated warnings with php 7.x
! worked with JoomGallery 3.x
